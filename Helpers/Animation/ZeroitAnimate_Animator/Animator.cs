...
namespace Zeroit.Framework.SnippetEditors
{
    ...
    public class ZeroitAnimator : Component, IExtenderProvider
    {
        ...
        {
            AnimationType = Zeroit.Framework.SnippetEditors.AnimationType.VertSlide;
        ...
        private void InitDefaultAnimation(Zeroit.Framework.SnippetEditors.AnimationType animationType)
        {
